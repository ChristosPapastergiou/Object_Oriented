...
public:
    ...
    virtual ~Toll(){}
    virtual int get_k() = 0;
    virtual void set_k(bool) = 0;
    virtual int get_list_size() = 0;
...
public:
    ...
    ~Worker_Toll(){}
    void operate(int, int, vector<Vehicle>*);
    int get_k(){return K;}
    int get_list_size(){return Toll_Vehicle.size();}
    int get_vehicles_served(){return Vehicles_served;}
...
public:
    ...
    ~Entrance();
    void operate(int, int, int, vector<Vehicle>*);
    int get_id(){return ID;}
    void set_delay(bool i){delay = i;}
...
public:
    ...
    int get_no_of_vehicles(){return Segment_Vehicle.size();}
